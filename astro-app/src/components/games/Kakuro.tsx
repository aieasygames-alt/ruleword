                ...
                row.map((cell, c) => (
                  ...
                  >
                    {cell.isBlack ? (
                      <>
                        {cell.colSum && (
                          <div className="absolute top-0.5 left-0.5 text-[10px] text-amber-400 font-bold">{cell.colSum}</div>
                        )}
                        {cell.rowSum && (
                          <div className="absolute bottom-0.5 right-0.5 text-[10px] text-cyan-400 font-bold">{cell.rowSum}</div>
                        )}
                      </>
                    ) : (
