...
const LEVELS: Level[] = [
  ...
  { size: 5, dots: [
    ...
    { pos: { x: 1, y: 1 }, color: '#ef4444' },
    { pos: { x: 0, y: 1 }, color: '#3b82f6' },
    { pos: { x: 3, y: 3 }, color: '#3b82f6' },
    { pos: { x: 2, y: 3 }, color: '#22c55e' },
    { pos: { x: 4, y: 4 }, color: '#22c55e' },
  ]},
  // Level 2 - Easy 5x5 (4 colors)
  { size: 5, dots: [
    { pos: { x: 0, y: 0 }, color: '#ef4444' },
    { pos: { x: 3, y: 1 }, color: '#ef4444' },
    { pos: { x: 2, y: 1 }, color: '#3b82f6' },
    { pos: { x: 2, y: 2 }, color: '#3b82f6' },
    { pos: { x: 3, y: 2 }, color: '#22c55e' },
    { pos: { x: 1, y: 3 }, color: '#22c55e' },
  ...
  { size: 5, dots: [
    { pos: { x: 0, y: 0 }, color: '#ef4444' },
    { pos: { x: 1, y: 3 }, color: '#ef4444' },
    { pos: { x: 1, y: 2 }, color: '#3b82f6' },
    { pos: { x: 2, y: 2 }, color: '#3b82f6' },
    { pos: { x: 2, y: 3 }, color: '#22c55e' },
    { pos: { x: 3, y: 1 }, color: '#22c55e' },
    { pos: { x: 3, y: 0 }, color: '#f59e0b' },
    { pos: { x: 4, y: 4 }, color: '#f59e0b' },
  ]},
  ...
  { size: 5, dots: [
    ...
    { pos: { x: 1, y: 3 }, color: '#ef4444' },
    { pos: { x: 2, y: 3 }, color: '#3b82f6' },
    { pos: { x: 2, y: 2 }, color: '#3b82f6' },
    { pos: { x: 1, y: 2 }, color: '#22c55e' },
    { pos: { x: 3, y: 1 }, color: '#22c55e' },
    { pos: { x: 4, y: 1 }, color: '#f59e0b' },
    { pos: { x: 0, y: 0 }, color: '#f59e0b' },
  ]},
  // Level 6 - Medium 6x6 (5 colors)
  { size: 6, dots: [
    { pos: { x: 0, y: 0 }, color: '#ef4444' },
    { pos: { x: 4, y: 1 }, color: '#ef4444' },
    { pos: { x: 3, y: 1 }, color: '#3b82f6' },
    { pos: { x: 2, y: 2 }, color: '#3b82f6' },
    { pos: { x: 3, y: 2 }, color: '#22c55e' },
    { pos: { x: 2, y: 3 }, color: '#22c55e' },
    { pos: { x: 1, y: 3 }, color: '#f59e0b' },
    { pos: { x: 4, y: 4 }, color: '#f59e0b' },
    { pos: { x: 5, y: 4 }, color: '#8b5cf6' },
    { pos: { x: 0, y: 5 }, color: '#8b5cf6' },
  ]},
  // Level 7 - Medium 6x6 (5 colors)
  { size: 6, dots: [
    { pos: { x: 0, y: 0 }, color: '#ef4444' },
    { pos: { x: 1, y: 4 }, color: '#ef4444' },
    { pos: { x: 1, y: 3 }, color: '#3b82f6' },
    { pos: { x: 2, y: 2 }, color: '#3b82f6' },
    { pos: { x: 2, y: 3 }, color: '#22c55e' },
    { pos: { x: 3, y: 2 }, color: '#22c55e' },
    { pos: { x: 3, y: 1 }, color: '#f59e0b' },
    { pos: { x: 4, y: 4 }, color: '#f59e0b' },
    { pos: { x: 4, y: 5 }, color: '#8b5cf6' },
    { pos: { x: 5, y: 0 }, color: '#8b5cf6' },
  ]},
  // Level 8 - Medium 6x6 (5 colors)
  { size: 6, dots: [
    { pos: { x: 0, y: 0 }, color: '#ef4444' },
    { pos: { x: 5, y: 2 }, color: '#ef4444' },
    { pos: { x: 5, y: 3 }, color: '#3b82f6' },
    { pos: { x: 1, y: 5 }, color: '#3b82f6' },
    { pos: { x: 0, y: 5 }, color: '#22c55e' },
    { pos: { x: 2, y: 1 }, color: '#22c55e' },
    { pos: { x: 3, y: 1 }, color: '#f59e0b' },
    { pos: { x: 2, y: 4 }, color: '#f59e0b' },
    { pos: { x: 1, y: 4 }, color: '#8b5cf6' },
    { pos: { x: 2, y: 3 }, color: '#8b5cf6' },
  ]},
  // Level 9 - Medium 6x6 (5 colors)
  { size: 6, dots: [
    { pos: { x: 5, y: 5 }, color: '#ef4444' },
    { pos: { x: 1, y: 4 }, color: '#ef4444' },
    { pos: { x: 2, y: 4 }, color: '#3b82f6' },
    { pos: { x: 3, y: 3 }, color: '#3b82f6' },
    { pos: { x: 2, y: 3 }, color: '#22c55e' },
    { pos: { x: 3, y: 2 }, color: '#22c55e' },
    { pos: { x: 4, y: 2 }, color: '#f59e0b' },
    { pos: { x: 1, y: 1 }, color: '#f59e0b' },
    { pos: { x: 0, y: 1 }, color: '#8b5cf6' },
    { pos: { x: 5, y: 0 }, color: '#8b5cf6' },
  ]},
  ...
  { size: 6, dots: [
    ...
    { pos: { x: 5, y: 1 }, color: '#3b82f6' },
    { pos: { x: 0, y: 1 }, color: '#3b82f6' },
    { pos: { x: 0, y: 2 }, color: '#22c55e' },
    { pos: { x: 5, y: 2 }, color: '#22c55e' },
    { pos: { x: 5, y: 3 }, color: '#f59e0b' },
    { pos: { x: 0, y: 3 }, color: '#f59e0b' },
    { pos: { x: 0, y: 4 }, color: '#8b5cf6' },
    { pos: { x: 5, y: 4 }, color: '#8b5cf6' },
    { pos: { x: 5, y: 5 }, color: '#ec4899' },
    { pos: { x: 0, y: 5 }, color: '#ec4899' },
  ]},
  ...
  { size: 6, dots: [
    ...
    { pos: { x: 2, y: 5 }, color: '#f59e0b' },
    { pos: { x: 2, y: 0 }, color: '#f59e0b' },
    { pos: { x: 1, y: 0 }, color: '#8b5cf6' },
    { pos: { x: 1, y: 5 }, color: '#8b5cf6' },
    { pos: { x: 0, y: 5 }, color: '#ec4899' },
    { pos: { x: 0, y: 0 }, color: '#ec4899' },
  ]},
  ...
  { size: 6, dots: [
    ...
    { pos: { x: 4, y: 1 }, color: '#f59e0b' },
    { pos: { x: 4, y: 2 }, color: '#8b5cf6' },
    { pos: { x: 1, y: 4 }, color: '#8b5cf6' },
    { pos: { x: 1, y: 3 }, color: '#ec4899' },
  ...
  { size: 7, dots: [
    ...
    { pos: { x: 4, y: 1 }, color: '#ef4444' },
    { pos: { x: 3, y: 1 }, color: '#3b82f6' },
    { pos: { x: 5, y: 2 }, color: '#3b82f6' },
    { pos: { x: 6, y: 2 }, color: '#22c55e' },
    { pos: { x: 1, y: 4 }, color: '#22c55e' },
    { pos: { x: 2, y: 4 }, color: '#f59e0b' },
    { pos: { x: 2, y: 5 }, color: '#f59e0b' },
    { pos: { x: 1, y: 5 }, color: '#8b5cf6' },
    { pos: { x: 6, y: 6 }, color: '#8b5cf6' },
  ]},
  // Level 14 - Hard 7x7 (6 colors)
  { size: 7, dots: [
    { pos: { x: 0, y: 0 }, color: '#ef4444' },
    { pos: { x: 1, y: 5 }, color: '#ef4444' },
    { pos: { x: 1, y: 4 }, color: '#3b82f6' },
    { pos: { x: 2, y: 2 }, color: '#3b82f6' },
    { pos: { x: 2, y: 3 }, color: '#22c55e' },
    ...
    { pos: { x: 4, y: 4 }, color: '#f59e0b' },
    { pos: { x: 4, y: 5 }, color: '#8b5cf6' },
    { pos: { x: 5, y: 1 }, color: '#8b5cf6' },
    { pos: { x: 5, y: 0 }, color: '#ec4899' },
    { pos: { x: 6, y: 6 }, color: '#ec4899' },
  ]},
  // Level 15 - Hard 7x7 (6 colors)
  { size: 7, dots: [
    { pos: { x: 0, y: 0 }, color: '#ef4444' },
    { pos: { x: 6, y: 2 }, color: '#ef4444' },
    { pos: { x: 6, y: 3 }, color: '#3b82f6' },
    { pos: { x: 2, y: 6 }, color: '#3b82f6' },
    { pos: { x: 1, y: 6 }, color: '#22c55e' },
    { pos: { x: 1, y: 1 }, color: '#22c55e' },
    { pos: { x: 2, y: 1 }, color: '#f59e0b' },
    { pos: { x: 5, y: 5 }, color: '#f59e0b' },
    { pos: { x: 4, y: 5 }, color: '#8b5cf6' },
    { pos: { x: 2, y: 2 }, color: '#8b5cf6' },
    { pos: { x: 3, y: 2 }, color: '#ec4899' },
    { pos: { x: 3, y: 3 }, color: '#ec4899' },
  ]},
  // Level 16 - Hard 7x7 (6 colors)
  { size: 7, dots: [
    { pos: { x: 0, y: 0 }, color: '#ef4444' },
    { pos: { x: 5, y: 1 }, color: '#ef4444' },
    { pos: { x: 4, y: 1 }, color: '#3b82f6' },
    { pos: { x: 2, y: 2 }, color: '#3b82f6' },
    { pos: { x: 3, y: 2 }, color: '#22c55e' },
    { pos: { x: 3, y: 3 }, color: '#22c55e' },
  ...
  { size: 7, dots: [
    ...
    { pos: { x: 5, y: 6 }, color: '#3b82f6' },
    { pos: { x: 4, y: 6 }, color: '#22c55e' },
    { pos: { x: 4, y: 0 }, color: '#22c55e' },
    { pos: { x: 3, y: 0 }, color: '#f59e0b' },
    { pos: { x: 3, y: 6 }, color: '#f59e0b' },
    { pos: { x: 2, y: 6 }, color: '#8b5cf6' },
    { pos: { x: 2, y: 0 }, color: '#8b5cf6' },
    { pos: { x: 1, y: 0 }, color: '#ec4899' },
    { pos: { x: 1, y: 6 }, color: '#ec4899' },
    { pos: { x: 0, y: 6 }, color: '#14b8a6' },
    { pos: { x: 0, y: 0 }, color: '#14b8a6' },
  ]},
  // Level 18 - Expert 7x7 (7 colors)
  { size: 7, dots: [
    { pos: { x: 0, y: 0 }, color: '#ef4444' },
    { pos: { x: 0, y: 6 }, color: '#ef4444' },
    { pos: { x: 1, y: 6 }, color: '#3b82f6' },
    { pos: { x: 1, y: 0 }, color: '#3b82f6' },
    { pos: { x: 2, y: 0 }, color: '#22c55e' },
    { pos: { x: 2, y: 6 }, color: '#22c55e' },
    { pos: { x: 3, y: 6 }, color: '#f59e0b' },
    { pos: { x: 3, y: 0 }, color: '#f59e0b' },
    { pos: { x: 4, y: 0 }, color: '#8b5cf6' },
    { pos: { x: 4, y: 6 }, color: '#8b5cf6' },
    { pos: { x: 5, y: 6 }, color: '#ec4899' },
    { pos: { x: 5, y: 0 }, color: '#ec4899' },
    { pos: { x: 6, y: 0 }, color: '#14b8a6' },
    { pos: { x: 6, y: 6 }, color: '#14b8a6' },
  ]},
  // Level 19 - Expert 7x7 (7 colors)
  { size: 7, dots: [
    { pos: { x: 0, y: 0 }, color: '#ef4444' },
    { pos: { x: 6, y: 0 }, color: '#ef4444' },
    { pos: { x: 6, y: 1 }, color: '#3b82f6' },
    { pos: { x: 5, y: 6 }, color: '#3b82f6' },
    { pos: { x: 4, y: 6 }, color: '#22c55e' },
    ...
    { pos: { x: 4, y: 1 }, color: '#f59e0b' },
    { pos: { x: 5, y: 1 }, color: '#8b5cf6' },
    { pos: { x: 3, y: 5 }, color: '#8b5cf6' },
    { pos: { x: 2, y: 5 }, color: '#ec4899' },
    { pos: { x: 3, y: 2 }, color: '#ec4899' },
    { pos: { x: 4, y: 2 }, color: '#14b8a6' },
    { pos: { x: 3, y: 3 }, color: '#14b8a6' },
  ]},
  ...
  { size: 7, dots: [
    ...
    { pos: { x: 6, y: 5 }, color: '#3b82f6' },
    { pos: { x: 6, y: 4 }, color: '#22c55e' },
    { pos: { x: 0, y: 4 }, color: '#22c55e' },
    { pos: { x: 0, y: 3 }, color: '#f59e0b' },
    { pos: { x: 6, y: 3 }, color: '#f59e0b' },
    { pos: { x: 6, y: 2 }, color: '#8b5cf6' },
    { pos: { x: 0, y: 2 }, color: '#8b5cf6' },
    { pos: { x: 0, y: 1 }, color: '#ec4899' },
    { pos: { x: 6, y: 1 }, color: '#ec4899' },
    { pos: { x: 6, y: 0 }, color: '#14b8a6' },
    { pos: { x: 0, y: 0 }, color: '#14b8a6' },
  ]},
  ...
  { size: 8, dots: [
    ...
    { pos: { x: 2, y: 1 }, color: '#3b82f6' },
    { pos: { x: 6, y: 3 }, color: '#3b82f6' },
    { pos: { x: 5, y: 3 }, color: '#22c55e' },
    { pos: { x: 6, y: 4 }, color: '#22c55e' },
    { pos: { x: 7, y: 4 }, color: '#f59e0b' },
    { pos: { x: 3, y: 6 }, color: '#f59e0b' },
    { pos: { x: 4, y: 6 }, color: '#8b5cf6' },
    { pos: { x: 0, y: 7 }, color: '#8b5cf6' },
  ]},
  ...
  { size: 8, dots: [
    ...
    { pos: { x: 1, y: 5 }, color: '#ef4444' },
    { pos: { x: 1, y: 4 }, color: '#3b82f6' },
    { pos: { x: 2, y: 5 }, color: '#3b82f6' },
    { pos: { x: 2, y: 6 }, color: '#22c55e' },
    { pos: { x: 4, y: 0 }, color: '#22c55e' },
    { pos: { x: 4, y: 1 }, color: '#f59e0b' },
    { pos: { x: 5, y: 4 }, color: '#f59e0b' },
    { pos: { x: 5, y: 3 }, color: '#8b5cf6' },
    { pos: { x: 6, y: 5 }, color: '#8b5cf6' },
    { pos: { x: 6, y: 6 }, color: '#ec4899' },
    { pos: { x: 7, y: 0 }, color: '#ec4899' },
  ]},
  // Level 23 - Advanced 8x8 (6 colors)
  { size: 8, dots: [
    { pos: { x: 7, y: 0 }, color: '#ef4444' },
    { pos: { x: 6, y: 5 }, color: '#ef4444' },
    { pos: { x: 6, y: 4 }, color: '#3b82f6' },
    { pos: { x: 5, y: 5 }, color: '#3b82f6' },
    { pos: { x: 5, y: 6 }, color: '#22c55e' },
    { pos: { x: 3, y: 0 }, color: '#22c55e' },
    { pos: { x: 3, y: 1 }, color: '#f59e0b' },
    { pos: { x: 2, y: 4 }, color: '#f59e0b' },
    { pos: { x: 2, y: 3 }, color: '#8b5cf6' },
  ...
  { size: 8, dots: [
    { pos: { x: 7, y: 0 }, color: '#ef4444' },
    { pos: { x: 2, y: 1 }, color: '#ef4444' },
    { pos: { x: 3, y: 1 }, color: '#3b82f6' },
    { pos: { x: 2, y: 2 }, color: '#3b82f6' },
    { pos: { x: 1, y: 2 }, color: '#22c55e' },
    { pos: { x: 7, y: 4 }, color: '#22c55e' },
    { pos: { x: 6, y: 4 }, color: '#f59e0b' },
    { pos: { x: 3, y: 5 }, color: '#f59e0b' },
    { pos: { x: 4, y: 5 }, color: '#8b5cf6' },
    { pos: { x: 2, y: 6 }, color: '#8b5cf6' },
    { pos: { x: 1, y: 6 }, color: '#ec4899' },
    { pos: { x: 7, y: 7 }, color: '#ec4899' },
  ]},
  // Level 25 - Advanced 8x8 (6 colors)
  { size: 8, dots: [
    { pos: { x: 7, y: 7 }, color: '#ef4444' },
    { pos: { x: 6, y: 2 }, color: '#ef4444' },
    { pos: { x: 6, y: 3 }, color: '#3b82f6' },
    { pos: { x: 5, y: 2 }, color: '#3b82f6' },
    { pos: { x: 5, y: 1 }, color: '#22c55e' },
    { pos: { x: 3, y: 7 }, color: '#22c55e' },
    { pos: { x: 3, y: 6 }, color: '#f59e0b' },
    { pos: { x: 2, y: 3 }, color: '#f59e0b' },
    { pos: { x: 2, y: 4 }, color: '#8b5cf6' },
    { pos: { x: 1, y: 2 }, color: '#8b5cf6' },
    { pos: { x: 1, y: 1 }, color: '#ec4899' },
    { pos: { x: 0, y: 7 }, color: '#ec4899' },
  ]},
  // Level 26 - Master 8x8 (7 colors)
  { size: 8, dots: [
    { pos: { x: 0, y: 0 }, color: '#ef4444' },
    { pos: { x: 6, y: 1 }, color: '#ef4444' },
    { pos: { x: 5, y: 1 }, color: '#3b82f6' },
    { pos: { x: 2, y: 2 }, color: '#3b82f6' },
    { pos: { x: 3, y: 2 }, color: '#22c55e' },
    { pos: { x: 4, y: 3 }, color: '#22c55e' },
    ...
    { pos: { x: 6, y: 6 }, color: '#ec4899' },
    { pos: { x: 7, y: 6 }, color: '#14b8a6' },
    { pos: { x: 0, y: 7 }, color: '#14b8a6' },
  ]},
  // Level 27 - Master 8x8 (7 colors)
  { size: 8, dots: [
    { pos: { x: 0, y: 0 }, color: '#ef4444' },
    { pos: { x: 1, y: 6 }, color: '#ef4444' },
    { pos: { x: 1, y: 5 }, color: '#3b82f6' },
    { pos: { x: 2, y: 2 }, color: '#3b82f6' },
    { pos: { x: 2, y: 3 }, color: '#22c55e' },
    ...
    { pos: { x: 4, y: 4 }, color: '#f59e0b' },
    { pos: { x: 4, y: 5 }, color: '#8b5cf6' },
    { pos: { x: 5, y: 2 }, color: '#8b5cf6' },
    { pos: { x: 5, y: 1 }, color: '#ec4899' },
    { pos: { x: 6, y: 6 }, color: '#ec4899' },
    { pos: { x: 6, y: 7 }, color: '#14b8a6' },
    { pos: { x: 7, y: 0 }, color: '#14b8a6' },
  ]},
  // Level 28 - Master 8x8 (7 colors)
  { size: 8, dots: [
    { pos: { x: 0, y: 0 }, color: '#ef4444' },
    { pos: { x: 7, y: 2 }, color: '#ef4444' },
    { pos: { x: 7, y: 3 }, color: '#3b82f6' },
    { pos: { x: 3, y: 7 }, color: '#3b82f6' },
    { pos: { x: 2, y: 7 }, color: '#22c55e' },
    { pos: { x: 0, y: 1 }, color: '#22c55e' },
    { pos: { x: 1, y: 1 }, color: '#f59e0b' },
    { pos: { x: 6, y: 4 }, color: '#f59e0b' },
    { pos: { x: 6, y: 5 }, color: '#8b5cf6' },
    { pos: { x: 1, y: 4 }, color: '#8b5cf6' },
    { pos: { x: 1, y: 3 }, color: '#ec4899' },
    { pos: { x: 5, y: 5 }, color: '#ec4899' },
    { pos: { x: 4, y: 5 }, color: '#14b8a6' },
    { pos: { x: 3, y: 4 }, color: '#14b8a6' },
  ]},
  ...
  { size: 8, dots: [
    ...
    { pos: { x: 2, y: 1 }, color: '#3b82f6' },
    { pos: { x: 5, y: 2 }, color: '#3b82f6' },
    { pos: { x: 4, y: 2 }, color: '#22c55e' },
    { pos: { x: 3, y: 3 }, color: '#22c55e' },
    { pos: { x: 4, y: 3 }, color: '#f59e0b' },
    { pos: { x: 3, y: 4 }, color: '#f59e0b' },
    { pos: { x: 2, y: 4 }, color: '#8b5cf6' },
    { pos: { x: 5, y: 5 }, color: '#8b5cf6' },
    { pos: { x: 6, y: 5 }, color: '#ec4899' },
    { pos: { x: 1, y: 6 }, color: '#ec4899' },
    { pos: { x: 0, y: 6 }, color: '#14b8a6' },
    { pos: { x: 7, y: 7 }, color: '#14b8a6' },
  ]},
  // Level 30 - Master 8x8 (7 colors)
  { size: 8, dots: [
    { pos: { x: 7, y: 7 }, color: '#ef4444' },
    { pos: { x: 6, y: 1 }, color: '#ef4444' },
    { pos: { x: 6, y: 2 }, color: '#3b82f6' },
    { pos: { x: 5, y: 5 }, color: '#3b82f6' },
    { pos: { x: 5, y: 4 }, color: '#22c55e' },
    { pos: { x: 4, y: 3 }, color: '#22c55e' },
    { pos: { x: 4, y: 4 }, color: '#f59e0b' },
    { pos: { x: 3, y: 3 }, color: '#f59e0b' },
    { pos: { x: 3, y: 2 }, color: '#8b5cf6' },
    { pos: { x: 2, y: 5 }, color: '#8b5cf6' },
    { pos: { x: 2, y: 6 }, color: '#ec4899' },
    { pos: { x: 1, y: 1 }, color: '#ec4899' },
    { pos: { x: 1, y: 0 }, color: '#14b8a6' },
    { pos: { x: 0, y: 7 }, color: '#14b8a6' },
  ]},
]
